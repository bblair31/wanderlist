...
city_ids = [77636, 53814, 9611, 11616, 60976, 22891, 85588]
user_id = 1
ratings = (1..5).to_a
...
#
# puts "DONE SEEDING"
# Tour.create(name: "Red Line Bus Tour", duration: "1/2 day", contact_info: "267-555-9787 redlineinfo@hotmail.com", city_id: 68853)
